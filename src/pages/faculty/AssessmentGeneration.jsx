...
import { generateQuestions } from '../../services/geminiServices'; // Import AI API function
import { getFacultyProfiles, postDataToBackend} from '../../api/api'; // Import function to get logged-in user's profile
...
function AssessmentCreation() {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      const response = await postDataToBackend('/assessments/create', {
        facultyId, 
        title,
        questions,
        deadline
